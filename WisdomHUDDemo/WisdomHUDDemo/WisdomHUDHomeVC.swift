...
//                }
        ...
        case .action:
            ...
            WisdomHUD.showAction(title: "WisdomHUD", text: text, label: "WisdomHUD sdk", leftAction: "leftAction", rightAction: "rightAction", themeStyle: .light, inSupView: nil) { info, pointStyle in
