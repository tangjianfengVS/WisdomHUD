...
//                }
        ...
        case .progress:
            ...
            if let cur_state = state {
                let contextable = WisdomHUD.showProgress(text: "上传文件", progressStyle: cur_state).setProgreColor(color: .systemPink).setProgreTextColor(color: .systemPink)//.setProgreShadowColor(color: .green)
